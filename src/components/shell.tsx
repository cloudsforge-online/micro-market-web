    ...
    <>
      ...
      */}
      ...
      <footer className="mk-footer">
        <p>
          Money on this surface is held by Forge Ledger, never by Forge Market: an escrow here is a
          reference to a reservation, not a balance. Fees and royalties are posted in the same
